...
const ProgressPage = () => {
  ...
  return (
    <div className="flex flex-col align-middle w-full gap-6 justify-between h-[60vh]">
      ...
      <button
        className="border self-center min-w-[342px] py-4 rounded-lg font-semibold bg-[#0062F5] hover:border-gray-300 hover:bg-white hover:text-gray-400 text-white  transition .5s mt-10"
